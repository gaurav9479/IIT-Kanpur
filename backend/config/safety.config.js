...
export const ALTITUDE_LANES = [
    { id: "L1", altitude: 30, direction: "NORTH_SOUTH" },
    { id: "L2", altitude: 50, direction: "EAST_WEST" },
    { id: "L3", altitude: 70, direction: "NORTH_SOUTH" },
    { id: "L4", altitude: 90, direction: "EAST_WEST" },
];

export const VERTICAL_BUFFER_M = 10;
export const TIME_SLOT_DURATION_S = 30;
export const MAX_DRONES_PER_SLOT = 3;
