 ...
 *
 * NOTE: NO_FLY_ZONES have been removed from this file.
 * All airspace zones are now user-defined and stored in MongoDB.
 * Use the Airspace Control page (/safety) to create zones dynamically.
 */
...
// ─────────────────────────────────────────────────────────────
// URLs
// Use VITE_API_HOST env var for mobile access (set in .env.local)
// Default falls back to Mac's local IP on same Wi-Fi network
// ─────────────────────────────────────────────────────────────
// ─────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────
// AIRSPACE ZONES
// All zones are now dynamic and managed via the Airspace Control
// page. Users draw NO_FLY, RESTRICTED, and PRIORITY zones on the
// map — they are stored in MongoDB and synced in real-time via
// WebSockets. There are NO hardcoded zone definitions here.
// ─────────────────────────────────────────────────────────────
